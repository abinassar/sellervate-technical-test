...
- Every comment, function, documentation, etc should be in english language.
- If any specific documentation or functionality in another language is required, it will be mentioned in the implemented prompt.